...
/**
 * create row on table serial manager.
 * @param data
 */
...
function reply_click(rowIdx) {
	var url ="/BundleBoxService/webapps/myapp/html/serialmanager/editserial.html?serial="
...
function callscreeninsert() {
	window.document.location.href = "/BundleBoxService/webapps/myapp/html/serialmanager/insertserial.html";
}
...
function callscreensearch() {
	...
	var url ="/BundleBoxService/webapps/myapp/html/serialmanager/searchserial.html?serial="
		+ serial
		+ "&date="
		+ date
		+ "&purchase="
